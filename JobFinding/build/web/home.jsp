        ...
        <body>
            ...
            <%@ include file="header.jsp" %>
                <main>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-10">
                                    ...
                                    <div class="text-center mb-4">
                                        <a href="create-post" class="btn head-btn1">Create New Post</a>
                                    </div>
                                        ...
                                        <div class="single-job-items mb-30">
                                            <div class="job-items">
                                                <div class="job-tittle">
                                                    ...
                                                    <ul>
                                                        <li><i class="far fa-user"></i> ${post.userType}</li>
                                                        <li><i class="far fa-clock"></i> ${post.createdAt}</li>
                                                        <li><i class="far fa-eye"></i> ${post.viewCount} views</li>
                                                        <li><i class="far fa-comment"></i> ${post.commentCount} comments
                                                        </li>
                                                        <li><i class="far fa-heart"></i> ${post.likeCount} likes</li>
                                                    </ul>
                                                    <p class="post-excerpt">${post.content}</p>
                                                </div>
                                            </div>
                                            <div class="items-link f-right">
                                                <c:if test="${post.userId eq sessionScope.user.id}">
                                                    <a href="update-post?id=${post.id}" class="btn head-btn2 mr-2">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <a href="#" onclick="deletePost(${post.id})" class="btn head-btn2">
                                                        <i class="fas fa-trash"></i> Delete
                                                    </a>
                                                </c:if>
                                                <a href="post-detail?id=${post.id}" class="btn head-btn1">
                                                    Read More
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center mt-4">
                                        <a href="posts" class="btn head-btn1">View All Posts</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Add Delete Post Confirmation Modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn head-btn2" data-dismiss="modal">Cancel</button>
                                    <button type="button" class="btn head-btn1" id="confirmDelete">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="right-caption">
                                        ...
                                        <div class="support-caption">
                                            <p class="pera-top">Mollit anim laborum duis au dolor in voluptate velit ess
                                                cillum dolore eu lore dsu quality mollit anim laborumuis au dolor in
                                                voluptate velit cillum.</p>
                                            <p>Mollit anim laborum.Duis aute irufg dhjkolohr in re voluptate velit
                                                esscillumlore eu quife nrulla parihatur. Excghcepteur signjnt occa
                                                cupidatat non inulpadeserunt mollit aboru. temnthp incididbnt ut labore
                                        ...
                                        <div class="single-footer-caption mb-30">
                                            <div class="footer-tittle">
                                                ...
                                                <div class="footer-pera">
                                                    <p>Heaven frucvitful doesn't cover lesser dvsays appear creeping
                                                        seasons so behold.</p>
                                                </div>
                                            </div>
                                        </div>
