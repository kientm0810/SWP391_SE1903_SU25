                            ...
                            <%@page import="java.util.*" %>
                                <%@page import="java.sql.SQLException" %>
                                    ...
                                    <% try { // Get the recruiter from the session Recruiter recruiter=(Recruiter)
                                        ...
                                        response.sendRedirect("login.jsp"); return; } // Initialize DAOs JobDAO
                                        jobDAO=new JobDAO(); ApplicationDAO applicationDAO=new ApplicationDAO(); // Get
                                        job listings with error handling List<JobListing> activeJobs = new ArrayList<>
                                            ();
                                            try {
                                            activeJobs = jobDAO.getJobListingsByRecruiter(recruiter.getId());
                                            } catch (SQLException e) {
                                            throw new ServletException("Error getting jobs: " + e.getMessage(), e);
                                            ...
                                            activeJobs = new ArrayList<>();
                                                ...
                                                List<Application> recentApplications = new ArrayList<>();
                                                        ...
                                                        throw new ServletException("Error getting applications: " +
                                                        e.getMessage(), e);
                                                        // Set to empty list if error occurs
                                                        recentApplications = new ArrayList<>();
                                                            ...
                                                            throw new ServletException("Error getting application
                                                            counts: " + e.getMessage(), e);
                                                            }
                                                            %>
