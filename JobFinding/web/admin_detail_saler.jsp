<!-- admin_detail_saler.jsp -->
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="models.Admin" %>
<!DOCTYPE html>
<html>
<% Admin m = (Admin) request.getAttribute("Saler"); %>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Saler Detail - Admin Panel</title>
        ...
        <div class="main-content">
            <div class="page-header">
                ...
                <div class="header-actions">
                    ...
                    <a href="AdminController?target=Saler&service=Update&ID=<%= m.getId() %>" class="btn btn-primary">
