                                ...
                                <div class="section-header">
                                    ...
                                    <div class="section-actions">
                                        <a href="list_cv" class="btn btn-light btn-sm">
                                            <i class="fas fa-external-link-alt me-1"></i>Manage CVs
                                        </a>
                                    </div>
                                </div>
                                <div class="section-body text-center">
                                    <div class="empty-state">
                                        ...
                                        <h6>CV Management</h6>
                                        <p class="mb-3">Manage your professional CVs in a dedicated workspace</p>
                                        <a href="list_cv" class="btn btn-primary">
                                            <i class="fas fa-external-link-alt me-2"></i>Go to CV Management
                                        </a>
                                    </div>
                                </div>
                            </div>
