...
<head>
    ...
    <style>
        ...
        .form-container {
            ...
            border-radius: 20px;
            padding: 40px;
            box-shadow: 0 0 20px rgba(0, 177, 79, 0.2);
        }
        h3 {
            color: #00b14f;
        }
...
<div class="container mt-5">
    <div class="mx-auto form-container" style="max-width: 600px;">
        ...
        <form method="post" action="register">
            ...
            <a href="login" class="btn btn-secondary w-100 mt-2">Đã có tài khoản? Đăng nhập</a>
            <a href="home" class="btn btn-secondary w-100 mt-2">Quay lại trang chủ</a>
...
<script>
    // Toggle field visibility by role
