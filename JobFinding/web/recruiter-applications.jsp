                ...
                <body>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <img id="modal-candidate-avatar" src="" class="candidate-avatar-large"
                                            alt="Avatar">
                                        <div class="ms-4">
                                            <h4 id="modal-candidate-name" class="mb-1"></h4>
                                            <p class="text-muted mb-1">
                                                <i class="fas fa-envelope me-2"></i><span
                                                    id="modal-candidate-email"></span>
                                            </p>
                                            <p class="text-muted mb-0">
                                                <i class="fas fa-phone me-2"></i><span
                                                    id="modal-candidate-phone"></span>
                                            </p>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="update-status-section p-3 bg-light rounded">
                                        ...
                                        <div class="alert alert-info mb-3" role="alert">
                                            ...
                                            <strong>Lưu ý:</strong> Khi cập nhật trạng thái, hệ thống sẽ <strong>tự động
                                                gửi email</strong>
                                        ...
                                        <form id="updateStatusForm" action="update-application-status" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label for="statusSelect" class="form-label fw-semibold">Trạng thái
                                                    mới</label>
                                            ...
                                            <!-- Rejection Reason Field (shown when status = rejected) -->
                                            <div id="rejectionReasonField" class="mb-3" style="display: none;">
                                                <label for="rejectionReason" class="form-label fw-semibold text-danger">
                                                ...
                                                <div class="form-text">Lý do này sẽ được gửi trong email thông báo cho
                                                    ứng viên.</div>
                                            </div>

                                            <!-- Offer Details Field (shown when status = offered) -->
                                            <div id="offerDetailsField" class="mb-3" style="display: none;">
                                                <label for="offerDetails" class="form-label fw-semibold text-success">
                                                    <i class="fas fa-handshake me-1"></i>Chi tiết đề nghị
                                                </label>
                                                <textarea id="offerDetails" name="offerDetails" class="form-control"
                                                    rows="3" placeholder="Nhập chi tiết đề nghị việc làm..."></textarea>
                                                <div class="form-text">Chi tiết này sẽ được gửi trong email chấp nhận
                                                    cho ứng viên.</div>
                                            </div>
                    ...
                    <script>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            const offerDetailsField = document.getElementById('offerDetailsField');
                            ...
                            document.querySelectorAll('.view-candidate-btn').forEach(button => {
                                button.addEventListener('click', function () {
                                    ...
                                    const sendEmailUrl = 'send-custom-email?recipientEmail=' + encodeURIComponent(this.dataset.email) +
                                        ...
                                        '&applicationId=' + this.dataset.applicationId;
