            ...
            <div class="dashboard-container">
                ...
                <div class="main-content">
                        ...
                        <div class="stat-card">
                            <div class="stat-card-header">
                                <div>
                                    ...
                                    <div class="stat-label">Post Types</div>
                                </div>
                        ...
                        <div class="stat-card">
                            <div class="stat-card-header">
                                <div>
                                    ...
                                    <div class="stat-label">Blog Types</div>
                                </div>
                    ...
                    <div class="quick-actions" style="margin-top: 30px;">
                        ...
                        <div class="action-buttons">
                            <a href="admin_post_types.jsp" class="action-btn" style="background-color: #2196f3;">
                                <i class="fas fa-tags"></i>
                                <span>Manage Post Types</span>
                            </a>
                            <a href="admin_create_post_type.jsp" class="action-btn" style="background-color: #4caf50;">
                                <i class="fas fa-plus"></i>
                                <span>Add Post Type</span>
                            </a>
                            <a href="admin_blog_types.jsp" class="action-btn" style="background-color: #ff9800;">
                                <i class="fas fa-layer-group"></i>
                                <span>Manage Blog Types</span>
                            </a>
                            <a href="admin_create_blog_type.jsp" class="action-btn" style="background-color: #9c27b0;">
                                <i class="fas fa-plus"></i>
