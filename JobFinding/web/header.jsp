                    ...
                    <c:if test="${sessionScope.role == 'recruiter'}">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="communityDropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="/JobFinding/create-post.jsp">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end notifications"
                                        ...
                                        <div class="tab-content all">
                                            <c:forEach var="noti" items="${sessionScope.notice}">
                                                <a href="/JobFinding/notification?service=detail&type=all&id=${noti.id}"
...
<link rel="stylesheet" href="/JobFinding/assets/css/header.css">

<script src="/JobFinding/assets/js/header.js"></script>
