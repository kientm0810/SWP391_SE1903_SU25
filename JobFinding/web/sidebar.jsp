        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-menu">
                <a href="admin_dashboard.jsp"
                    class="menu-item ${pageContext.request.servletPath == '/admin_dashboard.jsp' ? 'active' : ''}">
                ...
                <c:if test="${sessionScope.adminRole == 'manager' || sessionScope.adminRole == 'admin'}">
                    <a href="AdminController?target=Recruiter"
                        class="menu-item ${param.target == 'Recruiter' ? 'active' : ''}">
                ...
                <c:if test="${sessionScope.adminRole == 'saler' || sessionScope.adminRole == 'admin'}">
                    <a href="AdminSalerController?target=blog"
                        class="menu-item ${param.target == 'blog' ? 'active' : ''}">
                        <i class="fas fa-blog"></i>
                        <span>Manage Blogs</span>
                    </a>

                    <a href="AdminSalerController?target=banner"
                        class="menu-item ${param.target == 'banner' ? 'active' : ''}">
                ...
                <c:if test="${sessionScope.adminRole == 'admin'}">
                    <div class="menu-section">
                        <h6 class="menu-section-title">Content Types</h6>

                        <a href="admin_post_types.jsp"
                            class="menu-item ${pageContext.request.servletPath == '/admin_post_types.jsp' ? 'active' : ''}">
                            <i class="fas fa-tags"></i>
                            <span>Post Types</span>
                        </a>

                        <a href="admin_blog_types.jsp"
                            class="menu-item ${pageContext.request.servletPath == '/admin_blog_types.jsp' ? 'active' : ''}">
                            <i class="fas fa-layer-group"></i>
                            <span>Blog Types</span>
                        </a>
                    </div>
                </c:if>

                <c:if test="${sessionScope.adminRole == 'manager' || sessionScope.adminRole == 'admin'}">
                    <a href="AdminSalerController?target=program"
                        class="menu-item ${param.target == 'program' ? 'active' : ''}">
                        <i class="fas fa-bullseye"></i>
                        <span>Program</span>
                    </a>

                    <a href="reports.jsp"
                        class="menu-item ${pageContext.request.servletPath == '/reports.jsp' ? 'active' : ''}">
