...
<body>
        ...
        <div class="main-content">
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        <c:forEach var="manager" items="${vec}">
                            <tr>
                                <td>#${manager.id}</td>
                        ...
                        <ul class="pagination justify-content-center custom-pagination">
                            ...
                            <c:forEach begin="${currentPage > 3 ? currentPage - 2 : 1}" 
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a class="page-link" href="AdminController?target=Manager&page=${i}&recordsPerPage=${recordsPerPage}&sortField=${sortField}&sortOrder=${sortOrder}${searchParams != null ? '&submit=Search&fullName=' + searchParams.fullName : ''}">${i}</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
    ...
    <script>
        function changeRecordsPerPage() {
            ...
            window.location.href = 'AdminController?target=Manager&recordsPerPage=' + recordsPerPage + '&sortField=' + sortField + '&sortOrder=' + sortOrder;
        }
