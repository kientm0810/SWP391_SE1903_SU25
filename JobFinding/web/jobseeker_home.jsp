                                ...
                                <nav class="navbar navbar-expand-lg" role="navigation" aria-label="Main navigation">
                                    <div class="container">
                                        <a class="navbar-brand" href="${pageContext.request.contextPath}/home.jsp"
                                            aria-label="JobFinding Homepage">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarNav">
                                            <ul class="navbar-nav me-auto">
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="${pageContext.request.contextPath}/job_search.jsp">
                                                        <i class="fas fa-search me-2" aria-hidden="true"></i>Tìm việc
                                                        làm
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="${pageContext.request.contextPath}/cv_templates.jsp">
                                                        <i class="fas fa-file-alt me-2" aria-hidden="true"></i>Mẫu CV
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="${pageContext.request.contextPath}/companies.jsp">
                                                        <i class="fas fa-building me-2" aria-hidden="true"></i>Công ty
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="${pageContext.request.contextPath}/blog.jsp">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-light position-relative" type="button"
                                                        ...
                                                        <c:if
                                                            test="${not empty notifications and fn:length(notifications) > 0}">
                                                            <span
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end notification-dropdown"
                                                        ...
                                                        <h6
                                                            ...
                                                            <span>Thông báo</span>
                                                            <small class="text-muted">${fn:length(notifications)}
                                                                mới</small>
                                                        </h6>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <div class="text-center py-4">
                                                                    ...
                                                                    <p class="text-muted mb-0">Không có thông báo mới
                                                                    </p>
                                                                </div>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                ...
                                                                <i class="fas fa-user me-2" aria-hidden="true"></i>Hồ sơ
                                                                cá nhân
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="${pageContext.request.contextPath}/my_cvs.jsp">
                                                                <i class="fas fa-file-alt me-2"
                                                                    aria-hidden="true"></i>CV của tôi
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="${pageContext.request.contextPath}/applications.jsp">
                                                                <i class="fas fa-paper-plane me-2"
                                                                    aria-hidden="true"></i>Việc làm đã ứng tuyển
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="${pageContext.request.contextPath}/saved_jobs">
                                                                <i class="fas fa-heart me-2" aria-hidden="true"></i>Việc
                                                                làm đã lưu
                                                            </a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                ...
                                                                <i class="fas fa-cog me-2" aria-hidden="true"></i>Cài
                                                                đặt
                                                            </a>
                                                        </li>
                                                        <li>
                                            ...
                                            <section class="profile-card" aria-labelledby="profile-summary">
                                                <div class="profile-header">
                                                    <img src="<c:choose><c:when test='${not empty sessionScope.user.profilePicture}'><c:out value='${sessionScope.user.profilePicture}'/></c:when><c:otherwise>${pageContext.request.contextPath}/assets/images/default-avatar.png</c:otherwise></c:choose>"
                                                        ...
                                                        alt="Ảnh đại diện của <c:out value='${sessionScope.user.fullName}'/>">
                                                    <div class="profile-info">
                                                        ...
                                                        <p>
                                                            <c:choose>
                                                                <c:when
                                                                    test="${not empty sessionScope.user.desiredJobTitle}">
                                                                    <c:out value="${sessionScope.user.desiredJobTitle}"
                                                                        escapeXml="true" />
                                                                </c:when>
                                                                <c:otherwise>Chưa cập nhật vị trí mong muốn
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="profile-completion">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        ...
                                                        <span
                                                            class="text-primary fw-bold">${profileCompleteness}%</span>
                                                    </div>
                                                    <div class="progress" role="progressbar"
                                                        aria-label="Profile completion"
                                                        aria-valuenow="${profileCompleteness}" aria-valuemin="0"
                                                        aria-valuemax="100">
                                                    ...
                                                    <small class="text-muted">
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${profileCompleteness >= 50}">
                                                                <i class="fas fa-info-circle text-warning me-1"
                                                                    aria-hidden="true"></i>
                                                                Hoàn thiện thêm để tăng cơ hội việc làm
                                                            </c:when>
                                                            <c:otherwise>
                                                                <i class="fas fa-exclamation-circle text-danger me-1"
                                                                    aria-hidden="true"></i>
                                                ...
                                                <div class="p-3">
                                                    <div class="d-grid gap-2">
                                                        <a href="${pageContext.request.contextPath}/edit_profile.jsp"
                                                            ...
                                                            <i class="fas fa-edit me-2" aria-hidden="true"></i>Chỉnh sửa
                                                            hồ sơ
                                                        </a>
                                                        <a href="${pageContext.request.contextPath}/create_cv.jsp"
                                                            class="btn btn-outline-primary">
                                                            <i class="fas fa-plus me-2" aria-hidden="true"></i>Tạo CV
                                                            mới
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <section class="profile-card" aria-labelledby="profile-stats">
                                                ...
                                                <div class="stats-grid">
                                                    <div class="stat-item">
                                                        ...
                                                        <h5>${requestScope.applicationCount != null ?
                                                            requestScope.applicationCount : 0}</h5>
                                                        <p>Đã ứng tuyển</p>
                                                    </div>
                                                    <div class="stat-item">
                                                        <i class="fas fa-heart" aria-hidden="true"></i>
                                                        <h5>${requestScope.savedJobsCount != null ?
                                                            requestScope.savedJobsCount : 0}</h5>
                                                        <p>Đã lưu</p>
                                                    </div>
                                                    <div class="stat-item">
                                                        <i class="fas fa-eye" aria-hidden="true"></i>
                                                        <h5>${sessionScope.user.profileViews != null ?
                                                            sessionScope.user.profileViews : 0}</h5>
                                                        <p>Lượt xem</p>
                                                    </div>
                                                </div>
                                            </section>
                                            ...
                                            <section class="profile-card" aria-labelledby="recent-applications">
                                                <div class="section-title">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/applications.jsp"
                                                        ...
                                                        Xem tất cả <i class="fas fa-arrow-right ms-1"
                                                            aria-hidden="true"></i>
                                                    </a>
                                                </div>
                                                ...
                                                <c:choose>
                                                            ...
                                                            <article class="job-card">
                                                                <div
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="job-title">
                                                                            <a href="${pageContext.request.contextPath}/job_details.jsp?id=${app.jobListing.id}"
                                                                                ...
                                                                                <c:out value="${app.jobListing.title}"
                                                                                    escapeXml="true" />
                                                                            </a>
                                                                        </h6>
                                                                        <p class="job-company">
                                                                            <c:out
                                                                                value="${app.jobListing.recruiter.companyName}"
                                                                                escapeXml="true" />
                                                                        </p>
                                                                        <div class="job-meta">
                                                                            <span>
                                                                            ...
                                                                            <c:if
                                                                                test="${not empty app.jobListing.location}">
                                                                                <span>
                                                                                    <i class="fas fa-map-marker-alt"
                                                                                        aria-hidden="true"></i>
                                                                                    <c:out
                                                                                        value="${app.jobListing.location}"
                                                                                        escapeXml="true" />
                                                                                </span>
                                                                            </c:if>
                                                                        </div>
                                                                    ...
                                                                    <div class="flex-shrink-0 ms-3">
                                                                        <span
                                                                            class="badge-status status-${fn:toLowerCase(fn:replace(app.status, ' ', '_'))}"
                                                                            role="status"
                                                                            aria-label="Trạng thái: ${app.status}">
                                                    ...
                                                    <c:otherwise>
                                                        <div class="empty-state">
                                                            ...
                                                            <p>Bạn chưa ứng tuyển vào vị trí nào. Hãy tìm kiếm và ứng
                                                                tuyển công việc phù hợp!</p>
                                                            <a href="${pageContext.request.contextPath}/job_search.jsp"
                                                                class="btn btn-primary mt-3">
                                                                <i class="fas fa-search me-2" aria-hidden="true"></i>Tìm
                                                                việc làm ngay
                                                            </a>
                                                        </div>
                                                    </c:otherwise>
                                                ...
                                                <c:choose>
                                                            ...
                                                            <article class="job-card">
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-9">
                                                                        ...
                                                                        <p class="job-company">
                                                                            <c:out value="${job.recruiter.companyName}"
                                                                                escapeXml="true" />
                                                                        </p>
                                                                        <div class="job-meta">
                                                                            <c:if
                                                                    ...
                                                                    <div class="col-md-3 text-end">
                                                                        <div class="d-flex flex-column gap-2">
                                                                            ...
                                                                            <button
                                                                                class="btn btn-outline-primary btn-sm btn-save-job"
                                                                                data-job-id="${job.id}"
                                                    ...
                                                    <c:otherwise>
                                                        <div class="empty-state">
                                                            ...
                                                            <p>Hệ thống chưa tìm thấy việc làm phù hợp với hồ sơ của
                                                                bạn. Hãy cập nhật thông tin để nhận được gợi ý tốt hơn!
                                                            </p>
                                                            <div class="d-flex gap-2 justify-content-center mt-3">
                                                                <a href="${pageContext.request.contextPath}/edit_profile.jsp"
                                                                    class="btn btn-primary">
                                                                    <i class="fas fa-user-edit me-2"
                                                                        aria-hidden="true"></i>Cập nhật hồ sơ
                                                                </a>
                                                                <a href="${pageContext.request.contextPath}/job_search.jsp"
                                                                    class="btn btn-outline-primary">
                                                                    <i class="fas fa-search me-2"
                                                                        aria-hidden="true"></i>Tìm việc làm
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </c:otherwise>
